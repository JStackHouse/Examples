...
//方案二：自定义post
    ...
    {
        [paramString appendFormat:@"&%@=%@",key,para[key]];
    }
    
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:BASE_URL]cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:TIME_OUT];
